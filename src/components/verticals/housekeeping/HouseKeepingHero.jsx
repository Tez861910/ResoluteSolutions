      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="max-w-4xl">
          ...
          <p className="text-xl md:text-2xl mb-12 text-slate-200 max-w-4xl leading-relaxed">
            Your trusted sourcing and trading partner for bulk housekeeping
            products. Serving educational institutions, medical facilities, and
            industrial operations through our extensive vendor network and
            reliable procurement solutions.
          </p>
